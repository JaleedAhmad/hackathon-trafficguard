...
val OutfitFontFamily = FontFamily(
    Font(googleFont = OutfitFontName, fontProvider = fontProvider, weight = FontWeight.Light),
...
// Premium Typography definition conforming to Outfit Family
